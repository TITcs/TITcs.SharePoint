...
namespace TITcs.SharePoint.Services
{
    public abstract class ServiceBase : IHttpHandler, IRequiresSessionState
    {
        ...
        public void ProcessRequest(HttpContext context)
        {
            ...
            {
                Logger.Unexpected("ServiceBase.ProcessRequest", e.Message);
            ...
            public Request(HttpRequest request)
            {
                switch (request.RequestType)
                {
                    ...
                    default:
                    {
                        ...
                        Logger.Unexpected("ServiceBase.Request", message);
        ...
        getRoute:
            ...
            if (route.IndexOf(".sps", StringComparison.InvariantCulture) > -1)
            {
                ...
                Logger.Unexpected("ServiceBase.ValidateRoute", message);
                throw new Exception(message);
            }
        ...
        private object InvokeMethod()
        {
            ...
            if (metodo == null)
            {
                ...
                Logger.Unexpected("ServiceBase.InvokeMethod", message);
                throw new Exception(message);
            }
