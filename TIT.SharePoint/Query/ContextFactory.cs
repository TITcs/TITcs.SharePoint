...
#if DEBUG
                rootUrl = WebConfigurationManager.AppSettings["SharePoint_Root"];
#endif
            }
            else
            {
...
#else
            var rootUrl = WebConfigurationManager.AppSettings["SharePoint_Root"];
...
#else
            var rootUrl = WebConfigurationManager.AppSettings["SharePoint_Root"];//WebConfigurationManager.AppSettings["SharePoint_Root"];
...
#if DEBUG
                    var userName = WebConfigurationManager.AppSettings["SharePoint_UserName"];
                    var passWord = WebConfigurationManager.AppSettings["SharePoint_PassWord"];
                    var netDomain = WebConfigurationManager.AppSettings["SharePoint_NetDomain"];
