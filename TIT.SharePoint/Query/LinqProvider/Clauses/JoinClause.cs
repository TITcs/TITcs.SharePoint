...
namespace TITcs.SharePoint.Query.LinqProvider.Clauses
{
  ...
  public class JoinClause : IBodyClause, IQuerySource
  {
    ...
    [DebuggerDisplay ("{TITcs.SharePoint.Query.LinqProvider.Clauses.ExpressionTreeVisitors.FormattingExpressionTreeVisitor.Format (InnerSequence),nq}")]
    ...
    [DebuggerDisplay ("{TITcs.SharePoint.Query.LinqProvider.Clauses.ExpressionTreeVisitors.FormattingExpressionTreeVisitor.Format (OuterKeySelector),nq}")]
    ...
    [DebuggerDisplay ("{TITcs.SharePoint.Query.LinqProvider.Clauses.ExpressionTreeVisitors.FormattingExpressionTreeVisitor.Format (InnerKeySelector),nq}")]
    ...
    /// <summary>
    /// Accepts the specified visitor by calling its <see cref="IQueryModelVisitor.VisitJoinClause(TITcs.SharePoint.Query.LinqProvider.Clauses.JoinClause,TITcs.SharePoint.Query.LinqProvider.QueryModel,int)"/> 
    /// method.
    /// </summary>
   ...
   /// <summary>
   /// Accepts the specified visitor by calling its <see cref="IQueryModelVisitor.VisitJoinClause(TITcs.SharePoint.Query.LinqProvider.Clauses.JoinClause,TITcs.SharePoint.Query.LinqProvider.QueryModel,TITcs.SharePoint.Query.LinqProvider.Clauses.GroupJoinClause)"/> 
