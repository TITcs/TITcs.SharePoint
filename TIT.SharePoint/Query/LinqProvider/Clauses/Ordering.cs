...
namespace TITcs.SharePoint.Query.LinqProvider.Clauses
{
  /// <summary>
  ...
  public class Ordering
  {
    ...
    [DebuggerDisplay ("{TITcs.SharePoint.Query.LinqProvider.Clauses.ExpressionTreeVisitors.FormattingExpressionTreeVisitor.Format (Expression),nq}")]
