...
using TITcs.SharePoint.Query.LinqProvider.Collections;
using TITcs.SharePoint.Query.LinqProvider.Parsing.ExpressionTreeVisitors.Transformation.PredefinedTransformations;
using TITcs.SharePoint.Query.SharedSource.Utilities;

namespace TITcs.SharePoint.Query.LinqProvider.Parsing.ExpressionTreeVisitors.Transformation
{
  /// <summary>
