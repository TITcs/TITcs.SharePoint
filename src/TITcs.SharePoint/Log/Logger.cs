...
namespace TITcs.SharePoint.Log
{
    public class Logger
    {
        ...
        {
            WriteLog(LoggerCategory.Information, source, "");
        }
        ...
        public static void Debug(string source, string errorMessage = "")
        {
            WriteLog(LoggerCategory.Debug, source, errorMessage);
        }

        public static void Debug(string source, string errorMessage = "", params object[] parameters)
        {
            WriteLog(LoggerCategory.Debug, source, string.Format(errorMessage, parameters));
        }
