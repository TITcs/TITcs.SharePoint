...
namespace TITcs.SharePoint.Query.LinqProvider.EagerFetching
{
  /// <summary>
  ...
  /// where the <see cref="FetchRequestBase"/> occurred in the <see cref="TITcs.SharePoint.Query.LinqProvider.QueryModel.ResultOperators"/> list of the <see cref="SourceItemQueryModel"/>. From
