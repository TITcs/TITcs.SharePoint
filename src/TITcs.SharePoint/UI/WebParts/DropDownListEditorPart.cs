...
namespace TITcs.SharePoint.UI.WebParts
{
    ...
    public class DropDownListEditorPart : EditorPart
    {
        ...
        {
            var onClientScript = string.Format("var dialogOptions = SP.UI.$create_DialogOptions();dialogOptions.url = '{0}';SP.UI.ModalDialog.showModalDialog(dialogOptions);return false;", url);
